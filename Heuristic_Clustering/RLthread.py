...
class RLthread(ClusteringArmThread):
    ...
    def __init__(self, data, name, metric, seed, batch_size):
        self.run_count = batch_size
        ClusteringArmThread.__init__(self, data, name, metric, seed)  # populates config space
        self.smac = None
        ...
        # Shouls run with smac==0.13.1
        self.smac = PSMAC(scenario=self.clu_scenario, rng=self.seed, )
